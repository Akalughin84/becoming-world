...
• 🌿 **Быть без дела**  
  Отметь «Я был» — и это уже победа.

• 🕯 **Провести 3 минуты тишины**  
  Без мыслей. Без цели. Просто быть.

• 📖 **Вести дневник чувств**  
  Запиши, что переживаешь — без оценки.

• 🌌 **Запомнить сны**  
  Расскажи сон, который помнишь. Он важен.

• ✉️ **Написать письмо себе**  
  Через год, через жизнь — кому-то, кем ты станешь.

• 🌷 **Увидеть свой внутренний сад**  
  Каждое «здесь» — цветок. Ты не растёшь. Ты — уже сад.

• 🗺 **Увидеть карту роста**  
  Глубина, Связь, Покой, Вера — твой путь виден.

• 🌧️ **Включить звуки природы**  
  Дождь, огонь, океан — чтобы легче было быть.
